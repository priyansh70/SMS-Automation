/**
 * Extension Registration/Login Page Object
 * Handles phone verification and OTP for extension web app
 */
import { ExtensionBasePage } from "./ExtensionBasePage.js";
import { expect } from "@playwright/test";

export class ExtensionRegistrationPage extends ExtensionBasePage {
  // Locators
  getPhoneInput() {
  ...
  async requestOTP() {
    ...
    await this.page.waitForURL(/.*\/verify-otp/, 5000);
  }
  ...
  async completePhoneVerification(phoneNumber) {
    ...
    await this.page.waitForTimeout(2000); // Wait for post-login page to load
  }
}
